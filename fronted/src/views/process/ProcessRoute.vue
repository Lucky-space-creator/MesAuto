<template>
  <el-card>
    ...
    <el-dialog v-model="dialogVisible" title="新增工艺路线" width="520px">
      <el-form :model="form" label-width="90px">
        ...
        <el-form-item label="适用产品"><el-input v-model="form.materialName" /></el-form-item>
...
const form = reactive({ id: null, routeCode: '', routeName: '', materialName: '', version: 'V1.0' })
...
const openDialog = () => {
  Object.assign(form, { id: null, routeCode: '', routeName: '', materialName: '', version: 'V1.0' })
  dialogVisible.value = true
}

const handleSubmit = async () => {
  const data = await request.post('/process-route', form)
